# MiniCore-RTS
Modifying to trap RTS signal (routed to PD2 pin) during serial recieve interrupt, and do something different depending on RTS state at the instant the character is recognized.
